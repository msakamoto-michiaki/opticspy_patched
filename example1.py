...
#outputs dir
outdir = os.path.join("out", "examples", "example1")
...
newpath = rename_fixed_png(
    ...
    outdir,
    tag="example1_grid_n12"
)

analysis.spotdiagram(New_Lens, [1, 2, 3], [1, 2, 3], n=12, grid_type="grid")
rename_latest_spotdiagram(outdir, tag="example1_spot_grid_n12")
...
newpath = rename_fixed_png(
    "out/opticspy_ray_tracing_field__grid_generator.png",
    outdir,
    tag="example1_circular_n6"
)
analysis.spotdiagram(New_Lens, [1, 2, 3], [1, 2, 3], n=6, grid_type="circular")
rename_latest_spotdiagram(outdir, tag="example1_spot_circular_n6")
...
newpath = rename_fixed_png(
    "out/opticspy_ray_tracing_field__grid_generator.png",
    outdir,
    tag="example1_random_n100"
)
analysis.spotdiagram(New_Lens, [1, 2, 3], [1, 2, 3], n=100, grid_type="random")
rename_latest_spotdiagram(outdir, tag="example1_spot_random_n100")
