...
# ------------------------------------------------------------
# Purpose:
#   Build a triplet (Cooke-like) and verify entrance pupil computation + optional drawing.
# ------------------------------------------------------------

plt.show = lambda *a, **k: _save_and_close("opticspy_ray_tracing_tests_test11_draw_lens_and_rays__layout.png")
