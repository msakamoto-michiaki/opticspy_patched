...
L.add_surface(number=1, radius=10000000, thickness=1, glass="air")
L.add_surface(number=2, radius=61.07222, thickness=10.345634, glass="N-BK7_schott", STO=True)
...
_dst = os.path.join(OUT_DIR, "opticspy_ray_tracing_tests_test5_build_doublet__spotdiagram.png")
